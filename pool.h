...
class Pool
{
	public:
		...
		static mongoc_client_t *GetClient(const mongoc_uri_t *uri);
		static void ReturnClient(const mongoc_uri_t *uri, mongoc_client_t *client);

	private:
		static std::string GetHash(const mongoc_uri_t *uri);
